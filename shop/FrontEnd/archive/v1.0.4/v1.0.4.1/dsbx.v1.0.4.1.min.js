...
$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var f=a.length,e=0;e<f;e++){var h=a[e];if(b.call(c,h,e,a))return{i:e,v:h}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6-impl","es3");
angular.module("account.community",["account.community.service","promotion"]).controller("CommCreditCtrl",["$scope","$state","$ionicHistory","$rootScope","$ionicLoading","eventNames","CreditAPI",function(a,b,c,f,e,h,l){var g=function(){a.records=[];d(function(){e.show({template:"<ion-spinner></ion-spinner>",delay:100})},function(){e.hide()},function(){f.navToIndex()})},k=function(){a.records=void 0;a.pageNumber=void 0;a.hasRecord=void 0;a.initFinish=void 0},d=function(b,d,c){b();l.refresh(function(b){a.records=
...
a.refresh=function(){d(function(){},function(){$timeout(function(){a.$broadcast("scroll.refreshComplete")},500)},function(){})};a.canLoadMore=function(){return void 0===a.initFinish?!1:l.hasMoreToLoad()};g();f.$on("$stateChangeStart",function(a,b,d,c,e){if("app.account.community"===b.name||"app.account.community.invite"===b.name||"app.account.community.credit"===b.name||"app.account.community.exchange"===b.name){if("app.account.community.invite"===c.name||"app.account.community.credit"===c.name)return;
g()}"app.account.sales"!==b.name&&"app.account.sales.invite"!==b.name&&"app.account.sales.credit"!==b.name||"app.account.sales.invite"===c.name||"app.account.sales.credit"===c.name||g()});f.$on("event:auth-loginCancelled",function(){k()});f.$on("event:auth-logout-complete",function(){k()});f.$on(h.CREDIT_EXCHANGE_SUCCESS,function(a,b){k()})}]).controller("CommExchangeCtrl",["$scope","$state","$ionicHistory","$rootScope","$ionicLoading","eventNames","CreditExchangeAPI",function(a,b,c,f,e,h,l){a.exchange=
function(b){b.creditAmount>a.$parent.account.credit?alert("\u7231\u5fc3\u6570\u91cf\u4e0d\u8db3\uff0c\u8bf7\u83b7\u5f97\u66f4\u591a\u7231\u5fc3\u518d\u6765\u5151\u6362"):(e.show({template:"<ion-spinner></ion-spinner>",delay:100}),l.exchange(b.id,function(){e.hide();f.$broadcast(h.CREDIT_EXCHANGE_SUCCESS);alert("\u5151\u6362\u6210\u529f")},function(a){e.hide();alert(a)}))};(function(){a.rules=[];e.show({template:"<ion-spinner></ion-spinner>",delay:100});l.getRules(function(b){a.rules=b;e.hide()},function(a){e.hide();
alert(a);f.navToIndex()})})()}]).controller("CommInviteCtrl",["$scope","$state","$ionicHistory","$rootScope","$ionicLoading","eventNames","PromotionAPI","Wechat",function(a,b,c,f,e,h,l,g){var k=function(b){void 0===a.$parent||void 0===a.$parent.account?a.$on("account-ready",function(a,d){b()}):b()},d=function(){a.invitePromotionUrl=l.getShareUrl(a.$parent.account.invitePromotionId);e.show({template:"<ion-spinner></ion-spinner>",delay:100});l.getPublicBatch(a.$parent.account.invitePromotionId,function(b){e.hide();
a.batch=b;g.hookShareAll(!0,l.convertBatchToContent(a.batch),function(){},function(a){alert(a)})},function(a){e.hide();alert("\u672a\u627e\u5230\u5206\u4eab\u6d3b\u52a8\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\u6216\u7a0d\u540e\u518d\u8bd5")})};k(d);f.$on("$stateChangeStart",function(a,b,c,u,e){("app.account.community.invite"===b.name&&"app.account.community.invite"!==u.name&&"app.account.community.exchange"!==u.name&&"app.account.community.credit"!==u.name||"app.account.sales.invite"===b.name&&
"app.account.sales.invite"!==u.name)&&k(d)})}]);
angular.module("account.community.service",["ngResource"]).service("CreditAPI",["$resource","urlConfig",function(a,b){var c=a(b.REST_END_POINT+"/api/account/credit/record",{page:"@page"},{query:{method:"GET",isArray:!1,timeout:1E4}},null),f=function(a,b,d){c.query({page:a},function(a){for(var d=[],c=0;c<a.list.length;c++)h[a.list[c].id]=a.list[c],d.push(a.list[c]);console.log("credit record page data get page success");b(d)},function(a){d(a.data.error)})},e=function(a,b){h={};l=0;c.query({page:0},
function(b){l=b.metaData.total;for(var d=[],c=0;c<b.list.length;c++)h[b.list[c].id]=b.list[c],d.push(b.list[c]);console.log("credit record metaData init success");a(d)},function(a){b(a.data.error)})},h={},l=0;return{getPage:function(a,b,d){f(a,b,d)},get:function(a){return h[a]},refresh:function(a,b){e(a,b)},hasMoreToLoad:function(){return!!(void 0!==h&&0!==Object.keys(h).length&&Object.keys(h).length<l)},clean:function(){h=void 0;l=0}}}]).service("CreditExchangeAPI",["$resource","urlConfig",function(a,
b){var c=a(b.REST_END_POINT+"/api/account/credit/exchangeRule",{},{query:{method:"GET",isArray:!0,timeout:1E4}},null),f=a(b.REST_END_POINT+"/api/account/credit/exchangeRule/:ruleId/exchange",{ruleId:"@ruleId"},{exchange:{method:"POST",isArray:!1,timeout:1E4}},null),e=[],h=function(a,b){e=[];c.query({},function(b){e=b;console.log("credit exchange rule init success");a(e)},function(a){b("\u672a\u627e\u5230\u53ef\u5151\u6362\u5546\u54c1\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\u6216\u7a0d\u540e\u518d\u8bd5")})},
l=function(a,b,d){f.exchange({ruleId:a},function(a){b()},function(a){d(a.data.error)})};return{getRules:function(a,b){void 0===e||0===e.length?h(a,b):a(e)},exchange:function(a,b,d){l(a,b,d)}}}]);angular.module("account",["account.service","smsValidation","wechat","account.community"]).controller("AccountCtrl",["$scope","$state","$rootScope","$ionicLoading","AccountAPI","accountConstants","eventNames",function(a,b,c,f,e,h,l){a.state={info:1,edit:2};var g=function(){a.actState=a.state.info;f.show({template:"<ion-spinner></ion-spinner>",delay:100});e.getAccount(function(b){f.hide();a.account=b;a.$broadcast("account-ready",a.account)},function(a){f.hide();console.log("error getting account, by: "+
a);alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u8d26\u6237\u4fe1\u606f\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5");c.navToIndex()})};a.canEditCompany=function(){return a.account.type===h.ACCOUNT_TYPE_NORMAL};a.canEditEmail=function(){return a.account.type===h.ACCOUNT_TYPE_NORMAL};a.showEdit=function(){a.actState=a.state.edit;a.backupName=a.account.name;a.backupAddress=a.account.address;a.backupCompany=a.account.company;a.backupEmail=a.account.email};a.saveEdit=function(){f.show({template:"<ion-spinner></ion-spinner>",
...
function(a,b,c,e,f){"app.account"!==b.name&&"app.account.show"!==b.name||"app.account"===e.name||"app.account.show"===e.name||g()});c.$on("event:auth-loginCancelled",function(){e.clean();a.account=void 0});c.$on("event:auth-logout-complete",function(){e.clean();a.account=void 0});c.$on(l.CREDIT_EXCHANGE_SUCCESS,function(a,b){e.clean();g()})}]).controller("SalesOrCommCtrl",["$scope","$rootScope",function(a,b){var c=function(a){a.isSuperDXK?b.navToRoot("app.account.sales.credit"):b.navToRoot("app.account.community.credit")},
f=function(){void 0===a.$parent.account?a.$on("account-ready",function(b,f){c(a.$parent.account)}):c(a.$parent.account)};f();b.$on("$stateChangeStart",function(a,b,c,g,k){"app.account.salesOrComm"===b.name&&"app.account.salesOrComm"!==g.name&&(a.preventDefault(),f())})}]);
...
a);b(a)}):e.query({},function(b){f=b;a(f)},b)}else a(f)},saveAccount:function(a,b,c){e.save(a,function(c){f=a;b()},function(a){c(a)})},clean:function(){f=void 0}}}]);angular.module("agreement",["agreement.service","wechat"]).controller("AgreementCtrl",["$scope","$state","AgreementAPI","agreementConstants","$rootScope","$ionicLoading","eventNames",function(a,b,c,f,e,h,l){var g=function(b,n,v){a.initFinish=!1;h.show({template:"<ion-spinner></ion-spinner>",delay:100});c.findPublicByIdIn(d,function(d){a.toPropose="1"===b;a.showPaygo="1"===n;a.showUser="1"===v;a.publicAgreements=d;a.showUser?c.all(function(b){a.agreementlist=b;h.hide();a.initFinish=!0;for(b=0;b<a.agreementlist.length;b++)a.agreementlist[b].canPayWxpay=
-1<a.agreementlist[b].payMethods.indexOf(f.PAY_METHOD_H5)},function(b){h.hide();a.initFinish=!0;e.navToIndex()}):(h.hide(),a.initFinish=!0)},function(a){console.log("error initializing index, by: "+a);h.hide();alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u534f\u8bae\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5")})},k=function(){a.agreementlist=void 0;a.toPropose=void 0;a.showPaygo=void 0;a.showUser=void 0;a.publicAgreements=void 0;a.initFinish=void 0};a.expired=function(a){return new Date(a.endDate)<
new Date};var d=[f.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE,f.AGREEMENT_ID_PAYGO_LOCAL_ZH,f.AGREEMENT_ID_PAYGO_JB_LITE,f.AGREEMENT_ID_PAYGO_JB,f.AGREEMENT_ID_AUTO_PAYGO,f.AGREEMENT_ID_PAYGO_ZR,f.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN];g(b.params.toPropose,b.params.paygo,b.params.user);e.$on("$stateChangeStart",function(a,b,d,c,e){"app.agreement"!==b.name&&"app.agreement.list"!==b.name&&"app.agreement.detail"!==b.name||g(d.toPropose,d.paygo,d.user)});e.$on("event:auth-loginCancelled",function(){k()});e.$on("event:auth-logout-complete",
function(){k()});e.$on(l.PROPOSAL_SUCCESS,function(a,b){c.clean()});e.$on(l.AGREEMENT_CHARGE_SUCCESS,function(a,b){c.clean()})}]).controller("AgreementDetailCtrl",["$rootScope","$scope","$stateParams","AgreementAPI","eventNames","agreementConstants",function(a,b,c,f,e,h){var l=function(){f.find(c.id,function(a){b.agreement=a;b.agreement.canPayWxpay=-1<b.agreement.payMethods.indexOf(h.PAY_METHOD_H5)},function(a){b.message=a})};l();a.$on(e.AGREEMENT_CHARGE_SUCCESS,function(a,b){l()})}]).controller("AgreementPublicDetailCtrl",
["$rootScope","$scope","$stateParams","AgreementAPI","eventNames",function(a,b,c,f,e){(function(){f.findPublic(c.id,function(a){b.agreement=a},function(a){b.message=a})})()}]).controller("AgreementChargeCtrl",["$rootScope","$scope","$state","$stateParams","AgreementAPI","$ionicActionSheet","AccountAPI","agreementConstants","eventNames","Wechat","$ionicLoading","$ionicPopup",function(a,b,c,f,e,h,l,g,k,d,p,n){var v=function(){p.show({template:"<ion-spinner></ion-spinner>",delay:100});e.preOrder(b.chargeOrder,
function(a){console.log("pre order succeed");u(a)},function(a){p.hide();console.log("pre order error, by: ",a.data.error);alert(a.data.error)})},u=function(u){b.chargeOrder.orderId=u.orderId;d.doWxPay(u.paymentResponse,function(){p.hide();b.error=void 0;console.log("save order successfull");a.$broadcast(k.AGREEMENT_CHARGE_SUCCESS,suc);alert("\u5145\u503c\u91d1\u989d"+b.chargeOrder.fee+"\u5143\uff0c\u4ee3\u91d1\u5238\u5df2\u7ecf\u53d1\u653e\uff0c\u8bf7\u5230\u6211\u7684\u4f18\u60e0\u5238\u4e2d\u67e5\u770b");
c.go("app.agreement.detail",{id:f.id})},function(){p.hide();alert("\u652f\u4ed8\u5931\u8d25")})};(function(){p.show({template:"<ion-spinner></ion-spinner>",delay:100});e.find(f.id,function(a){b.agreement=a;b.agreement.invoiceTypes=g.INVOICE_TYPES;l.getAccount(function(a){b.account=a;b.chargeOrder={agreement:b.agreement,chargeRule:b.agreement.chargeRules[0],fee:b.agreement.chargeRules[0]?b.agreement.chargeRules[0].chargeAmount:0};b.account.invoiceSetting&&(b.chargeOrder.companyTaxId=b.account.invoiceSetting.companyTaxId);
b.chargeOrder.invoiceType=g.INVOICE_TYPE_NORMAL;p.hide()},function(a){console.log("error getting account, by: "+a);p.hide();alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u652f\u4ed8\u4fe1\u606f\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5")})},function(a){p.hide();b.message=a})})();b.showRules=function(){for(var a=[],d=0;d<b.agreement.chargeRules.length;d++)a[d]={text:"<div>"+b.agreement.chargeRules[d].name+"</div><p>"+b.agreement.chargeRules[d].description+"</p>"};h.show({buttons:a,
buttonClicked:function(a){b.chargeOrder.chargeRule=b.agreement.chargeRules[a];b.chargeOrder.fee=b.chargeOrder.chargeRule.chargeAmount;return!0}})};b.canShowTaxId=function(){return void 0!==b.chargeOrder&&b.chargeOrder.invoiceType!==g.INVOICE_TYPE_NORMAL};b.wxPay=function(){void 0===d.getOpenId()?alert("\u672a\u68c0\u6d4b\u5230\u5fae\u4fe1\u652f\u4ed8\u73af\u5883\uff0c\u8bf7\u5728\u5fae\u4fe1\u516c\u4f17\u53f7\u4e2d\u64cd\u4f5c"):(b.chargeOrder.buyerId=d.getOpenId(),b.chargeOrder.payProvider=g.PAY_PROVIDER_WX,
v())}}]);
angular.module("agreement.service",["ngResource"]).service("AgreementAPI",["$resource","urlConfig","agreementConstants",function(a,b,c){var f=function(a,b){return a.displayIndex-b.displayIndex},e=function(a,b){return a.pinyin>a.pinyin?1:a.pinyin<b.pinyin?-1:0},h=function(a,b){return a.value-b.value},l=a(b.REST_END_POINT+"/api/public/agreement",null,{query:{method:"GET",isArray:!1,timeout:1E4}},null),g,k,d=a(b.REST_END_POINT+"/api/agreement",null,{query:{method:"GET",isArray:!0,timeout:1E4}},null),
p=a(b.REST_END_POINT+"/api/order/charge"),n=a(b.REST_END_POINT+"/api/order/:id/finish"),v,u=function(a,b){l.query({},function(b){console.log("public agreement init success");g=b.contexts.divisions.sort(e);k=b.agreements;k[c.AGREEMENT_ID_AUTO_PAYGO].divisions=g;k[c.AGREEMENT_ID_AUTO_PAYGO].goods.sort(f);k[c.AGREEMENT_ID_AUTO_PAYGO].coverages.sort(h);k[c.AGREEMENT_ID_AUTO_PAYGO].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_LOCAL_ZH].divisions=g;k[c.AGREEMENT_ID_PAYGO_LOCAL_ZH].goods.sort(f);
k[c.AGREEMENT_ID_PAYGO_LOCAL_ZH].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_LOCAL_ZH].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_JB].divisions=g;k[c.AGREEMENT_ID_PAYGO_JB].goods.sort(f);k[c.AGREEMENT_ID_PAYGO_JB].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_JB].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_JB_LIMIT_PRICE].divisions=g.filter(function(a){return 100===a.defaultRouteFeeRate});k[c.AGREEMENT_ID_PAYGO_JB_LIMIT_PRICE].goods.sort(f);k[c.AGREEMENT_ID_PAYGO_JB_LIMIT_PRICE].coverages.sort(h);
k[c.AGREEMENT_ID_PAYGO_JB_LIMIT_PRICE].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE].divisions=g;k[c.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE].goods.sort(f);k[c.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_JB_LITE].divisions=g;k[c.AGREEMENT_ID_PAYGO_JB_LITE].goods.sort(f);k[c.AGREEMENT_ID_PAYGO_JB_LITE].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_JB_LITE].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_ZH_LIMIT_PRICE].divisions=
g.filter(function(a){return 100===a.defaultRouteFeeRate});k[c.AGREEMENT_ID_PAYGO_ZH_LIMIT_PRICE].goods.sort(f);k[c.AGREEMENT_ID_PAYGO_ZH_LIMIT_PRICE].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_ZH_LIMIT_PRICE].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN].divisions=g;k[c.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN].goods.sort(f);k[c.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_PAYGO_ZR].divisions=g;k[c.AGREEMENT_ID_PAYGO_ZR].goods.sort(f);
k[c.AGREEMENT_ID_PAYGO_ZR].coverages.sort(h);k[c.AGREEMENT_ID_PAYGO_ZR].invoiceTypes=c.INVOICE_TYPES;k[c.AGREEMENT_ID_SIGNUP_COUPON].divisions=g.filter(function(a){return 100===a.defaultRouteFeeRate});k[c.AGREEMENT_ID_SIGNUP_COUPON].goods.sort(f);k[c.AGREEMENT_ID_SIGNUP_COUPON].coverages.sort(h);k[c.AGREEMENT_ID_COUPON_TRANSACTION_25].divisions=g.filter(function(a){return 100===a.defaultRouteFeeRate});k[c.AGREEMENT_ID_COUPON_TRANSACTION_25].goods.sort(f);k[c.AGREEMENT_ID_COUPON_TRANSACTION_25].coverages.sort(h);
k[c.AGREEMENT_ID_SIMULATE].divisions=g;k[c.AGREEMENT_ID_SIMULATE].goods.sort(f);k[c.AGREEMENT_ID_SIMULATE].coverages.sort(h);b=Object.keys(k);for(var d=0;d<b.length;d++){for(var u=k[b[d]].coverages[0],y=k[b[d]].coverages[0],n=0;n<k[b[d]].coverages.length;n++)k[b[d]].coverages[n].discountFee=Math.round(k[b[d]].coverages[n].basefee*k[b[d]].discountRate/100),u.value>k[b[d]].coverages[n].value&&(u=k[b[d]].coverages[n]),y.value<k[b[d]].coverages[n].value&&(y=k[b[d]].coverages[n]);k[b[d]].lowCoverage=u;
k[b[d]].highCoverage=y;k[b[d]].backgroundUrl=c.BACKGROUND_ROOT+b[d]+".jpg";k[b[d]].matrix=c.PUBLIC_AGREEMENT_MATRIX[b[d]]}a()},b)},t=function(a,b){d.query({},function(b){v=b;console.log("user agreement init success");b=v;for(var d=0;d<b.length;d++)b[d].goods.sort(f),b[d].coverages.sort(h);a(v)},b)},x=function(a,b,d){void 0===k?u(function(){void 0===k||void 0===k[a]?d("\u534f\u8bae\u672a\u627e\u5230\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458"):b(k[a])},d):b(k[a])},r=function(a,b){for(var d={},c=0;c<
b.length;c++)void 0!==a[b[c]]&&(d[b[c]]=a[b[c]]);return d},q=function(a,b,d){t(function(c){for(var e,y=0;y<c.length;y++)c[y].id===parseInt(a)&&(e=c[y]);void 0===e?d("\u672a\u627e\u5230\u534f\u8bae\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458"):void 0===g?u(function(){void 0===g?d("\u534f\u8bae\u7ebf\u8def\u672a\u627e\u5230\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458"):(e.divisions=g,b(e))},d):(e.divisions=g,b(e))},d)};return{getProposal:function(a,b,d){a===c.AGREEMENT_ID_AUTO_PAYGO||a===c.AGREEMENT_ID_PAYGO_LOCAL_ZH||
a===c.AGREEMENT_ID_PAYGO_JB||a===c.AGREEMENT_ID_PAYGO_JB_LIMIT_PRICE||a===c.AGREEMENT_ID_PAYGO_ZH_LIMIT_PRICE||a===c.AGREEMENT_ID_PAYGO_ZR||a===c.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE||a===c.AGREEMENT_ID_PAYGO_JB_LITE||a===c.AGREEMENT_ID_SIGNUP_COUPON||a===c.AGREEMENT_ID_COUPON_TRANSACTION_25||a===c.AGREEMENT_ID_SIMULATE||a===c.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN?x(a,b,d):q(a,b,d)},findPublicByIdIn:function(a,b,d){void 0===k?u(function(){void 0===k?d("\u534f\u8bae\u672a\u627e\u5230\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458"):
b(r(k,a))},d):b(r(k,a))},all:function(a,b){void 0===v?t(function(){a(v)},function(a){console.log(a);b(a)}):a(v)},findPublic:function(a,b,d){x(a,b,d)},find:function(a,b,d){q(a,b,d)},clean:function(){v=void 0},preOrder:function(a,b,d){(new p(a)).$save({},function(a){b(a)},function(a){d(a)})},finishOrder:function(a,b,d){(new n).$save({id:a},function(a){b(a)},function(a){d(a)})}}}]);angular.module("app",["smsValidation","wechat","account"]).controller("AppCtrl",["$scope","$ionicModal","$rootScope","$state","authService","$ionicHistory","$ionicLoading","CommonAuthenticationService","Wechat","$timeout","$ionicPopup","AccountAPI",function(a,b,c,f,e,h,l,g,k,d,p,n){d(function(){window.loading_screen.finish()},1500);a.isQQBrowser=!!k.isQQBrowser();c.navToRoot=function(a,b){h.nextViewOptions({historyRoot:!0});f.go(a,b)};c.navToIndex=function(){c.navToRoot("app.portal.category")};b.fromTemplateUrl("templates/app/login.html",
{scope:a}).then(function(b){a.modal=b});a.loginConfirmed=function(){e.loginConfirmed()};a.quit=function(){g.quit(function(){c.$broadcast("event:auth-logout-complete")})};a.cancel=function(){e.loginCancelled()};a.$on("event:auth-loginRequired",function(b,d){console.log("Login required");l.hide();a.modal.show()});a.$on("event:auth-loginConfirmed",function(){a.modal.hide()});a.$on("event:auth-loginCancelled",function(){a.modal.hide();h.nextViewOptions({historyRoot:!0});c.navToIndex()});a.$on("event:auth-logout-complete",
function(){h.nextViewOptions({historyRoot:!0});c.navToIndex()});a.$on("event:auth-forbidden",function(){console.log("Auth forbidden");l.hide();a.modal.show()});a.updateAccountPopup=function(b,d,c,e,f){a.data={};a.fieldName=d;a.data[d]=b[d];p.show({template:'<form> <textarea rows="3"  ng-model="data[fieldName]" class="value-right"></textarea></form>',title:e,subTitle:f,scope:a,buttons:[{text:"\u53d6\u6d88"},{text:"<b>\u786e\u8ba4</b>",type:"button-positive",onTap:function(e){if(a.data[d])if("\u672a\u586b\u5199"==
a.data[d]||""==a.data[d])alert("\u8bf7\u786e\u8ba4"+c+"\u540d\u79f0\u6b63\u786e\u518d\u63d0\u4ea4");else{l.show({template:"<ion-spinner></ion-spinner>",delay:100});var u=b[d];b[d]=a.data[d];n.saveAccount(b,function(a){l.hide()},function(a){b[d]=u;alert("\u4fdd\u5b58"+c+"\u4fe1\u606f\u5931\u8d25"+a.data.error);l.hide()})}else e.preventDefault()}}]})};c.$on("$stateChangeStart",function(a,b,d,c,e){console.log(c.name+" to "+b.name)})}]);angular.module("claim",["ionic","claim.service","wechat"]).controller("ClaimCtrl",["$scope","$stateParams","$state","$ionicLoading","$timeout","ClaimAPI","$ionicHistory","Wechat","$ionicPopup","$rootScope","$ionicPopover",function(a,b,c,f,e,h,l,g,k,d,p){a.navtoroot=function(a,b){l.nextViewOptions({historyRoot:!0});c.go(a,b)};var n=function(b,d){a.transtionId=b;a.claim=void 0;f.show({template:"<ion-spinner></ion-spinner>",delay:100});h.get(b,function(b){a.claim=b;if(null!==a.claim.registerno&&void 0!==
...
{scope:a})};a.openPopover=function(b){a.popover.show(b)};a.closePopover=function(){a.popover.hide()};a.bigImage=!1;a.Url="#";a.hideBigImage=function(){a.bigImage=!1;a.closePopover()};a.showBigImage=function(b,d){a.Url=b;a.bigImage=!0;a.openPopover(d)};d.$on("$stateChangeStart",function(b,d,c,e,f){"app.claim.start"!==d.name&&"app.claim.result"!==d.name||"app.claim.confirm"===e.name||void 0===c.id||""===c.id.id||n(c.id,!0);"app.claim.result"===d.name&&v();"app.claim.result"===e.name&&(a.claim=void 0);
"app.claim.upload"===d.name&&"app.claim.confirm"===e.name&&g.hookShareAll(!0,h.getShareContent(c.result),function(){},function(a){alert(a)})});void 0!==b.id&&""!==b.id&&n(b.id,!0)}]).controller("ClaimUploadCtrl",["$scope","$stateParams","$state","$ionicLoading","$timeout","ClaimAPI","$ionicHistory","Wechat","$ionicPopup","$rootScope",function(a,b,c,f,e,h,l,g,k,d){a.navtoroot=function(a,b){l.nextViewOptions({historyRoot:!0});c.go(a,b)};e(function(){window.loading_screen.finish()},1500);var p=function(b){a.transtionId=
b;a.claim=void 0;f.show({template:"<ion-spinner></ion-spinner>",delay:100});h.get(b,function(b){a.claim=b;f.hide()},function(a){f.hide()})},n=null,v=!1;a.getlocation=function(){v=!1;f.show({template:"<ion-spinner></ion-spinner>",delay:100});var b=e(function(){!1===v&&(f.hide(),alert("\u83b7\u53d6\u5730\u7406\u4f4d\u7f6e\u4fe1\u606f\u5931\u8d25\u8bf7\u7a0d\u540e\u518d\u8bd5"))},6E3);g.getUserLocation(function(d){v=!0;b&&e.cancel(b);JSON.stringify(d);var c=d.latitude;d=d.longitude;var f=new qq.maps.LatLng(c,
d);a.claim.latitude=c;a.claim.longitude=d;n.getAddress(f)},function(a){f.hide();alert(a)})};a.uploadFile=function(b){g.chooseImage(function(d){a.claim.imgList[b]=d.toString();f.show({template:"<ion-spinner></ion-spinner>",delay:100});g.uploadImage(a.claim.imgList[b],function(d){h.downloadFile(a.claim.id,d,b,function(d){f.hide();a.claim.imgList[b]=d.data;a.$apply()},function(a){f.hide()})},function(a){f.hide()})},function(a){alert(a)})};a.commitClaim=function(){if(void 0===a.claim.gpsaddress||""===
...
d=9-b;9!==b?alert("\u8bf7\u4f9d\u6b21\u9009\u62e9\u51719\u5f20\u7167\u7247\u8fdb\u884c\u4e0a\u4f20,\u5df2\u4e0a\u4f20"+b+"\u5f20 \u8fd8\u9700"+d+"\u5f20"):(f.show({template:"<ion-spinner></ion-spinner>",delay:100}),h.commitClaim(a.claim,function(b){f.hide();a.claim=b.data;a.showhistoryrecord=!0;a.navtoroot("^.result",{id:a.claim.transactionId,result:a.claim})},function(a){f.hide();alert("\u63d0\u4ea4\u62a5\u6848\u51fa\u73b0\u95ee\u9898\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002")}))}};d.$on("$stateChangeStart",
function(b,d,c,e,f){"app.claim.upload"===e.name&&(a.claim=void 0,v=!1);"app.claim.upload"===d.name&&(JSON.stringify(c),p(c.id))});void 0!==b.id&&""!==b.id&&p(b.id);(function(){n=new qq.maps.Geocoder({complete:function(b){f.hide();a.claim.gpsaddress=b.detail.addressComponents.province===b.detail.addressComponents.city?b.detail.addressComponents.country+b.detail.addressComponents.province+b.detail.addressComponents.city+b.detail.addressComponents.district+b.detail.addressComponents.street+b.detail.addressComponents.streetNumber:
b.detail.addressComponents.country+b.detail.addressComponents.city+b.detail.addressComponents.district+b.detail.addressComponents.street+b.detail.addressComponents.streetNumber;a.$apply()}})})()}]).controller("ClaimListCtrl",["$scope","$stateParams","$state","$ionicLoading","$timeout","ClaimAPI","$ionicHistory","Wechat","$ionicPopup","$rootScope",function(a,b,c,f,e,h,l,g,k,d){e(function(){window.loading_screen.finish()},1500);d.$on("$stateChangeStart",function(b,d,c,e,f){"app.claim.list"===e.name&&
(a.claims=void 0);"app.claim.list"===d.name&&p()});var p=function(){f.show({template:"<ion-spinner></ion-spinner>",delay:100});h.getAll(function(b){JSON.stringify(b);a.claims=b;f.hide()},function(a){f.hide();alert("\u83b7\u53d6\u7406\u8d54\u4fe1\u606f\u5931\u8d25\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002")})};p()}]).controller("ClaimHistoryListCtrl",["$scope","$stateParams","$state","$ionicLoading","$timeout","ClaimAPI","$ionicHistory","Wechat","$ionicPopup",function(a,b,c,f,e,h,l,g,k){e(function(){window.loading_screen.finish()},
...
c.views.transition("none");c.backButton.text("\u8fd4\u56de")}]);angular.module("coupon",["coupon.service","wechat","ng-iscroll"]).controller("CouponCtrl",["$scope","$state","$ionicHistory","CouponAPI","$rootScope","$ionicLoading","eventNames","couponConstants","agreementConstants",function(a,b,c,f,e,h,l,g,k){var d=function(){a.coupons=[];a.refresh(function(){h.show({template:"<ion-spinner></ion-spinner>",delay:100})},function(){h.hide()},function(){e.navToIndex()})},p=function(){a.coupons=void 0;a.pageNumber=void 0;a.hasCoupon=void 0;a.initFinish=void 0};a.refresh=
function(b,d,c){b();f.refresh(function(b){a.coupons=b;a.pageNumber=0;a.hasCoupon=!(void 0===a.coupons||0===a.coupons.length);a.initFinish=!0;d()},function(b){a.initFinish=!0;console.log(b);alert("\u5237\u65b0\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5");d();c()})};a.isTransType=function(a){return a.fullfillType===g.COUPON_TYPE_TRANS};a.isLimitPriceType=function(a){return a.fullfillType===g.COUPON_TYPE_LIMIT_PRICE};a.isVoucherType=function(a){return a.fullfillType===g.COUPON_TYPE_PRODUCT_VOUCHER};
a.isDiscountType=function(a){return a.fullfillType===g.COUPON_TYPE_DISCOUNT_VOUCHER};a.isNotUsed=function(a){return a.status===g.COUPON_STATUS_NOT_USED};a.navToProposal=function(a){if(a.fullfillType===g.COUPON_TYPE_TRANS)b.go("app.proposal.start",{agreementId:a.fullfillConfig,payCouponId:a.id});else{for(var d,c,e,f,p=0;p<a.scopes.length;p++)a.scopes[p].type===g.COUPON_SCOPE_TYPE_AGREEMENT_TYPE?(d=1,c=a.scopes[p].config):a.scopes[p].type===g.COUPON_SCOPE_TYPE_TAG&&a.scopes[p].config===g.COUPON_SCOPE_CONFIG_PAYGO?
e=1:a.scopes[p].type===g.COUPON_SCOPE_TYPE_TAG&&a.scopes[p].config===g.COUPON_SCOPE_CONFIG_USER&&(f=1);1===d?b.go("app.proposal.start",{agreementId:c,payCouponId:a.id}):b.go("app.agreement.list",{toPropose:"1",paygo:e,user:f})}};a.loadNext=function(b){a.canLoadNext()&&f.getPage(a.pageNumber+1,function(d){if(void 0!==d&&0!==d.length){for(var c=0;c<d.length;c++)a.coupons.push(d[c]);a.pageNumber++}b()},function(a){alert(a);b()})};a.canLoadNext=function(){return f.hasMoreToLoad()};d();e.$on("$stateChangeStart",
function(a,b,c,e,f){"app.coupon"!==b.name&&"app.coupon.list"!==b.name&&"app.coupon.detail"!==b.name&&"app.coupon.listQQx5"!==b.name||"app.coupon.detail"===e.name||"app.coupon.list"===e.name||"app.coupon.listQQx5"===e.name||d()});e.$on("event:auth-loginCancelled",function(){p()});e.$on("event:auth-logout-complete",function(){p()});e.$on(l.PROPOSAL_SUCCESS,function(a,b){f.clean()});e.$on(l.CREDIT_EXCHANGE_SUCCESS,function(a,b){f.clean()})}]).controller("CouponListCtrl",["$scope","$timeout",function(a,
...
a.page};a.nextPage=function(){a.$parent.pageNumber>a.page?a.page++:a.$parent.canLoadNext()?a.$parent.loadNext(function(){a.$parent.pageNumber>a.page&&a.page++}):alert("\u5df2\u7ecf\u662f\u6700\u540e\u4e00\u9875")};a.preOrRefreshPage=function(){1<a.page?a.page--:1!==a.page&&0!==a.page||a.refresh()};a.refresh=function(){a.$parent.refresh(function(){},function(){a.page=0},function(){})};a.page=0;b.$on("$stateChangeStart",function(b,f,e,h,l){"app.coupon"!==f.name&&"app.coupon.list"!==f.name&&"app.coupon.detail"!==
f.name&&"app.coupon.listQQx5"!==f.name||"app.coupon.detail"===h.name||"app.coupon.list"===h.name||"app.coupon.listQQx5"===h.name||(a.page=0)})}]);
angular.module("coupon.service",["ngResource"]).service("CouponAPI",["$resource","urlConfig",function(a,b){var c=a(b.REST_END_POINT+"/api/marketing/coupon",{page:"@page",agreementId:"@agreementId"},{query:{method:"GET",isArray:!1,timeout:1E4}},null),f=function(a,b,d,e){c.query({page:a,agreementId:b},function(a){for(var b=[],c=0;c<a.list.length;c++)h[a.list[c].id]=a.list[c],b.push(a.list[c]);console.log("coupon page data init success");d(b)},function(a){e(a.data.error)})},e=function(a,b){h={};l=0;
c.query({page:0},function(b){l=b.metaData.total;for(var d=[],c=0;c<b.list.length;c++)h[b.list[c].id]=b.list[c],d.push(b.list[c]);console.log("coupon metaData init success");a(d)},function(a){b(a.data.error)})},h={},l=0;return{getPage:function(a,b,d){f(a,void 0,b,d)},refresh:function(a,b){e(a,b)},get:function(a){return h[a]},findAllByAgreementId:function(a,b,d){f(void 0,a,b,d)},hasMoreToLoad:function(){return!!(void 0!==h&&0!==Object.keys(h).length&&Object.keys(h).length<l)},clean:function(){h=void 0;
l=0}}}]);/*
...
b.add=!1;break}};a.apply=function(){a.applyInvoices=[];for(var d in a.invoices)a.invoices.hasOwnProperty(d)&&!0===a.invoices[d].add&&a.applyInvoices.push(a.invoices[d]);void 0!==a.applyInvoices.length&&0!==a.applyInvoices.length?b.go("^.apply"):alert("\u8bf7\u9009\u62e9\u9700\u8981\u5f00\u5177\u7684\u53d1\u7968")};k();e.$on("$stateChangeStart",function(a,b,d,c,e){"app.invoice"!==b.name&&"app.invoice.list"!==b.name&&"app.invoice.apply"!==b.name||"app.invoice.list"===c.name||"app.invoice.apply"===c.name||
k()});e.$on("event:auth-loginCancelled",function(){d()});e.$on("event:auth-logout-complete",function(){d()});e.$on(l.INVOICE_APPLY_SUCCESS,function(a,b){f.clean();d();k()})}]).controller("InvoiceApplyCtrl",["$scope","InvoiceAPI","$rootScope","$state","$ionicLoading","$ionicHistory","invoiceConstants","eventNames",function(a,b,c,f,e,h,l,g){var k=function(){a.invoice={invoiceType:a.$parent.applyInvoices[0].invoiceType,invoiceTypeAlias:l.TYPES[a.$parent.applyInvoices[0].invoiceType],isValueAdded:a.$parent.applyInvoices[0].invoiceType!==
...
function(){e.hide();alert("\u53d1\u7968\u5c06\u57287\u4e2a\u5de5\u4f5c\u65e5\u5185\u5bc4\u51fa\uff0c\u8bf7\u8010\u5fc3\u7b49\u5019");c.navToRoot("app.invHistory.list");c.$broadcast(g.INVOICE_APPLY_SUCCESS)},function(a){e.hide();alert(a)})}};k();c.$on("$stateChangeStart",function(a,b,c,e,f){"app.invoice.apply"===b.name&&"app.invoice.apply"!==e.name&&k()});c.$on(g.INVOICE_APPLY_SUCCESS,function(){a.invoice=void 0});c.$on("event:auth-loginCancelled",function(){a.invoice=void 0});c.$on("event:auth-logout-complete",
function(){a.invoice=void 0})}]);
angular.module("invoice.service",[]).service("InvoiceAPI",["$resource","urlConfig",function(a,b){var c=a(b.REST_END_POINT+"/api/invoice/item",{},{query:{method:"GET",isArray:!0,timeout:1E4}},null),f=a(b.REST_END_POINT+"/api/invoice/"),e=function(a,b){c.query({},function(b){for(var d=[],c=0;c<b.length;c++)d.push(b[c]);console.log("invoice init success");a(d)},function(a){b(a.data.error)})},h=function(a,b,c){(new f(a)).$save({},function(a){console.log("apply successful");b(a)},function(a){c(a.data.error)})};
return{apply:function(a,b,c){h(a,b,c)},refresh:function(a,b){e(a,b)},clean:function(){invoices=void 0}}}]);angular.module("portal",["category.service","agreement"]).controller("PortalCtrl",["$scope","$timeout","$state","$rootScope","$ionicLoading","CategoryAPI","accountConstants","eventNames","AgreementAPI","agreementConstants","categoryConstants",function(a,b,c,f,e,h,l,g,k,d,p){var n=[d.AGREEMENT_ID_PAYGO_LOCAL_JB_LITE,d.AGREEMENT_ID_PAYGO_LOCAL_ZH,d.AGREEMENT_ID_PAYGO_JB_LITE,d.AGREEMENT_ID_PAYGO_JB,d.AGREEMENT_ID_AUTO_PAYGO,d.AGREEMENT_ID_PAYGO_ZR,d.AGREEMENT_ID_PAYGO_ZH_COLD_CHAIN];(function(){a.shakeClass=
"animated infinite shake";e.show({template:"<ion-spinner></ion-spinner>",delay:100});k.findPublicByIdIn(n,function(d){a.publicAgreements=d;h.findAll(function(d){a.categories=d.category;for(var c in a.categories)d=a.categories[c],a.categories[c].icon=void 0!==p.icon[d.id]?p.icon[d.id]:p.icon[0];e.hide();b(function(){a.shakeClass=""},3E3)},function(d){b(function(){a.shakeClass=""},3E3);alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u54c1\u7c7b\u4fe1\u606f\u5931\u8d25\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\u8bf4\u7a0d\u540e\u518d\u8bd5")})},
function(d){e.hide();b(function(){a.shakeClass=""},3E3);alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u4ea7\u54c1\u4fe1\u606f\u5931\u8d25\uff0c\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458\u8bf4\u7a0d\u540e\u518d\u8bd5")})})()}]).controller("PortalCategoryCtrl",["$scope","$stateParams",function(a,b){""===b.id?(a.showCategory=!0,a.showQuickIcons=!0,a.rootCategory=!0):(console.log(b.id+" category"),a.categoryId=b.id)}]);
angular.module("category.service",["ngResource"]).constant("categoryConstants",{icon:{0:"ion-ios-list",1:"ion-ios-list",2:"ion-ios-paper",3:"ion-ios-speedometer"}}).service("CategoryAPI",["$resource","urlConfig",function(a,b){var c,f=a(b.REST_END_POINT+"/api/public/category",null,{query:{method:"GET",isArray:!1,timeout:1E4}},null);return{findAll:function(a,b){void 0===c?f.query({},function(b){c=b;a(c)},b):a(c)}}}]);angular.module("promotion",["account.service","agreement.service","promotion.service","wechat.service"]).controller("PromotionCtrl",["$scope","$rootScope","PromotionAPI","promotionConstants","promotionBackgroundColors","$ionicLoading","$ionicHistory","$state","Wechat",function(a,b,c,f,e,h,l,g,k){var d=function(d,g,k){h.show({template:"<ion-spinner></ion-spinner>",delay:100});c.get(d,function(b){a.promotion=b;a.backStyle=void 0!==e[a.promotion.fromPicId]?{"background-color":e[a.promotion.fromPicId]}:
{"background-color":"#FFF"};a.promotion.fromPicUrl=f.PIC_ROOT+a.promotion.fromPicId+"_from.jpg";p(a.promotion.id,g,k)},function(a){h.hide();alert("\u672a\u627e\u5230\u4f18\u60e0\u6d3b\u52a8");b.navToIndex()})},p=function(d,e,f){c.newBatch(d,e,f,function(b){h.hide();a.batch=b.batch;a.gifts=b.gifts;void 0!==a.gifts&&void 0!==a.gifts[0]&&alert("\u611f\u8c22\u53c2\u4e0e\u6d3b\u52a8\uff0c\u5956\u52b1\u5df2\u653e\u5165\u8d26\u6237");k.hookShareTimelineOnly(!0,c.convertBatchToContent(a.batch),function(){n(a.promotion.id,
a.batch.id)},function(a){alert(a)})},function(a){h.hide();alert(a);b.navToIndex()})},n=function(d,e){h.show({template:"<ion-spinner></ion-spinner>",delay:100});c.shareAction(d,e,function(d){h.hide();a.gifts=d.gifts;void 0===a.gifts||void 0===a.gifts[0]?alert("\u6210\u529f\u5206\u4eab"):alert("\u6210\u529f\u5206\u4eab\uff0c\u5956\u52b1\u5df2\u653e\u5165\u8d26\u6237");b.navToIndex()},function(a){h.hide();alert(a);b.navToIndex()})};d(g.params.id,g.params.sourceType,g.params.sourceDetail);a.shareSuccess=
function(){n(a.promotion.id,a.batch.id)};b.$on("$stateChangeStart",function(a,b,c,e,f){"app.promotion"===b.name&&d(c.id,c.sourceType,c.sourceDetail)});b.$on("event:auth-loginCancelled",function(){a.promotion=void 0});b.$on("event:auth-logout-complete",function(){a.promotion=void 0})}]);
...
sourceType:"@sourceType",sourceDetail:"@sourceDetail",action:"@action"},{"new":{method:"POST",isArray:!1},action:{method:"POST",isArray:!1}}),l=a(b.REST_END_POINT+"/api/public/marketing/promotion/:batchId/",{batchId:"@batchId"}),g,k={};return{getPaySucPromotion:function(a,b){void 0===g?e.getPaySuc({},function(b){g=b[0];a(g)},function(a){b(a)}):a(g)},getPublicBatch:function(a,b,c){l.get({batchId:a},function(a){b(a)},function(a){c(a)})},get:function(a,b,c){void 0===k[a]?e.get({id:a},function(d){k[a]=
d;b(k[a])},function(a){c(a)}):b(k[a])},newBatch:function(a,b,c,e,f){h["new"]({id:a,sourceType:b,sourceDetail:c},function(a){console.log("batch created received");e(a)},function(a){console.log("failed because: "+a.data.error);f(a.data.error)})},shareAction:function(a,b,c,e){h.action({id:a,batchId:b,action:"FROM_SHARE"},function(a){console.log("share success");c(a)},function(a){console.log("failed because: "+a.data.error);e(a.data.error)})},getShareUrl:function(a){return b.REST_END_POINT+f.PROMOTION_SHARE_ROOT+
a},convertBatchToContent:function(a){var b={};b.name=a.toTitle;b.description=a.toDescription;b.url=this.getShareUrl(a.id);return b}}}]);angular.module("proposal",["proposal.service","account.service","promotion.service","coupon.service","wechat"]).controller("ProposalCtrl",["$rootScope","$scope","AgreementAPI","AccountAPI","CouponAPI","Proposal","PromotionAPI","$state","$stateParams","$ionicHistory","$ionicLoading","agreementConstants","promotionConstants","eventNames","Wechat","$ionicActionSheet","$ionicModal",function(a,b,c,f,e,h,l,g,k,d,p,n,v,u,t,x,r){var q={name:"\u4e0d\u4f7f\u7528"},y=function(){p.show({template:"<ion-spinner></ion-spinner>",
delay:100});f.getAccount(function(a){b.account=a;b.canPayCredit=-1<b.agreement.payMethods.indexOf(n.PAY_METHOD_CREDIT);b.canPayAlipay=!1;b.canPayWxpay=-1<b.agreement.payMethods.indexOf(n.PAY_METHOD_H5);b.canPayCoupon=-1<b.agreement.payMethods.indexOf(n.PAY_METHOD_COUPON);b.canPaySimulate=-1<b.agreement.payMethods.indexOf(n.PAY_METHOD_SIMULATE);b.canShowInvoice=b.canPayWxpay;b.isUserAgreementUseWxpay=b.canPayWxpay&&b.agreement.type===n.AGREEMENT_TYPE_USER;b.account.invoiceSetting&&(b.proposal.companyTaxId=
...
alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u652f\u4ed8\u4fe1\u606f\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5")})},B=function(d){b.success=d.success;b.orderId=d.orderId;b.proposalNo=d.proposalNo;g.params.agreementId!==n.AGREEMENT_ID_SIMULATE?l.getPaySucPromotion(function(d){p.hide();b.promotion=d;a.navToRoot("^.result")},function(b){console.log("No Pay Success Promotion found");p.hide();a.navToRoot("^.result")}):(console.log("No showing pay Success Promotion"),p.hide(),a.navToRoot("^.result"))},
m=function(){p.show({template:"<ion-spinner></ion-spinner>",delay:100});h.preOrder(b.proposal,function(a){console.log("pre order succeed");z(a)},function(a){p.hide();console.log("pre order error, by: ",a.data.error);alert(a.data.error)})},z=function(a){b.proposal.orderId=a.orderId;a.payProvider===n.PAY_PROVIDER_WX&&a.paymentResponse?t.doWxPay(a.paymentResponse,function(){w(a)},function(){p.hide();alert("\u652f\u4ed8\u5931\u8d25")}):w(a)},w=function(d){d.payProvider===n.PAY_PROVIDER_WX&&d.paymentResponse?
(b.error=void 0,console.log("save transaction successfull"),a.$broadcast(u.PROPOSAL_SUCCESS,d),B(d)):h.finishOrder(b.proposal.orderId,function(d){b.error=void 0;console.log("save transaction successfull");a.$broadcast(u.PROPOSAL_SUCCESS,d);B(d)},function(d){p.hide();console.log("save transaction failed, error:"+d.data.error);b.error=d.data.error;a.navToRoot("^.result")})},A=function(a){a=h.calcFeeDistance(a,function(a){success(a)},function(a){alert("\u83b7\u53d6\u91cc\u7a0b\u6570\u636e\u5931\u8d25\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002")})};
console.log("reloading");(function(d,e){p.show({template:"<ion-spinner></ion-spinner>",delay:100});console.log("Initializing proposal");c.getProposal(d,function(a){b.agreement=a;b.canSetRoutePreset=b.agreement.routePreset===n.AGREEMENT_ROUTE_PRESET_BOTH;b.canSetRouteNoPreset=b.agreement.routePreset===n.AGREEMENT_ROUTE_PRESET_NONE;b.canSetRouteStartEndEqual=b.agreement.routePreset===n.AGREEMENT_ROUTE_PRESET_EQUAL;b.canSetPublicRouteStartEndDetail=b.agreement.routePreset===n.AGREEMENT_ROUTE_PRESET_DISTANCE&&
b.agreement.type!==n.AGREEMENT_TYPE_USER;b.canSetPrivateRouteStartEndDetail=b.agreement.routePreset===n.AGREEMENT_ROUTE_PRESET_DISTANCE&&b.agreement.type===n.AGREEMENT_TYPE_USER;b.proposal=h.init(b.agreement);void 0!==e&&(b.proposal.payCouponId=e);p.hide()},function(b){console.log("error intializing proposal, by: "+b);p.hide();alert("\u670d\u52a1\u5668\u672a\u54cd\u5e94\uff0c\u83b7\u53d6\u534f\u8bae\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5");a.navToIndex()})})(g.params.agreementId,g.params.payCouponId);
b.calcfee=function(a){h.calcfee(a)};b.showGoods=function(){for(var a=[],d=0;d<b.agreement.goods.length;d++)a[d]={text:"<div>"+b.agreement.goods[d].name+"  \u52a0\u8d39\u7387:"+b.agreement.goods[d].baseFee+"%</div><p>"+b.agreement.goods[d].remark+"</p>"};x.show({buttons:a,buttonClicked:function(a){b.proposal.goods=b.agreement.goods[a];b.calcfee(b.proposal);return!0}})};b.canShowCurFee=function(){return g.params.agreementId!==n.AGREEMENT_ID_SIGNUP_COUPON&&g.params.agreementId!==n.AGREEMENT_ID_COUPON_TRANSACTION_25&&
...
angular.module("proposal.service",["ngResource"]).service("Proposal",["$resource","urlConfig","agreementConstants","couponConstants",function(a,b,c,f){var e=a(b.REST_END_POINT+"/api/order/transaction"),h=a(b.REST_END_POINT+"/api/order/:id/finish",{id:"@id"},{finish:{method:"POST",isArray:!1,timeout:6E4}}),l=a(b.REST_END_POINT+"/api/public/distance",{routeStart:"@routeStart",routeEnd:"@routeEnd"},{get:{method:"GET",isArray:!1,timeout:6E4}}),g=function(a){var b=a.agreement.routeAdjust,d=1;a.agreement.canChooseTheft&&
a.theftInsure&&(d=a.agreement.productDqRate);var e=a.goods.baseFee/100+1,g=a.route.baseRate/100,k=a.agreement.discountRate/100;-1<a.agreement.payMethods.indexOf(c.PAY_METHOD_H5)&&a.agreement.type===c.AGREEMENT_TYPE_USER&&a.theftInsure?a.listPrice=Math.round(a.coverage.basefee*e*g*b)+50:a.listPrice=Math.round(a.coverage.basefee*e*g*b*d);a.feeNoCoupon=Math.round(a.listPrice*k);void 0!==a.optionalCoupon&&void 0!==a.optionalCoupon.fullfillType?a.optionalCoupon.fullfillType===f.COUPON_TYPE_PRODUCT_VOUCHER?
(a.fee=a.feeNoCoupon-a.optionalCoupon.fullfillConfig,a.optionalCouponId=a.optionalCoupon.id):a.optionalCoupon.fullfillType===f.COUPON_TYPE_LIMIT_PRICE?(a.fee=a.optionalCoupon.fullfillConfig,a.optionalCouponId=a.optionalCoupon.id):a.optionalCoupon.fullfillType===f.COUPON_TYPE_DISCOUNT_VOUCHER&&(a.fee=Math.round(a.optionalCoupon.fullfillConfig/100*a.feeNoCoupon),a.optionalCouponId=a.optionalCoupon.id):(a.fee=a.feeNoCoupon,a.optionalCouponId=void 0)},k=function(a){a.agreement.routePreset===c.AGREEMENT_ROUTE_PRESET_EQUAL&&
...
b.routeStartProvince.politicalCitys[0],b.routeEnd=b.routeEndProvince.politicalCitys[0],b.route={})):(b.routeStart=a.divisions[0],b.routeEnd=a.divisions[0],b.route={});b.coverage=a.coverages[0];a.canChooseTheft&&(b.theftInsure=!1);b.invoiceType=c.INVOICE_TYPE_NORMAL;b.agreement.routePreset===c.AGREEMENT_ROUTE_PRESET_DISTANCE?(b.routeDistanceFees=a.routeDistanceFees,this.calcFeeDistance(b,null,null)):this.calcfee(b);return b},calcfee:function(a){k(a);g(a)},save:function(a,b,c){a=new e(a);a.$save({},
b,c);return a},preOrder:function(a,b,c){(new e(a)).$save({},function(a){b(a)},function(a){c(a)})},finishOrder:function(a,b,c){h.finish({id:a},function(a){b(a)},function(a){c(a)})},calcFeeDistance:function(a,b,e){a.agreement.routePreset===c.AGREEMENT_ROUTE_PRESET_DISTANCE&&(new l).$save({routeStart:a.routeStart.name,routeEnd:a.routeEnd.name},function(b){a.routeDistance=b.distance;b=[];for(var c=0,d=0;d<a.agreement.coverages.length;d++)for(var e=a.agreement.coverages[d],f=e.value,q=0;q<a.routeDistanceFees.length;q++){var y=
a.routeDistanceFees[q];f==y.value&&a.routeDistance>y.distanceStart&&a.routeDistance<=y.distanceEnd&&(e.basefee=y.fee,b[c++]=e)}a.distanceCoverages=b;a.coverage=b[0];k(a);g(a)},function(a){e(a)})},doWxPay:function(a,b,c){function d(){WeixinJSBridge.invoke("getBrandWCPayRequest",{appId:a.appId,timeStamp:a.timeStamp,nonceStr:a.nonceStr,"package":a.packagePrepayId,signType:a.signType,paySign:a.paySign},function(a){"get_brand_wcpay_request:ok"==a.err_msg?b():(alert(a.err_msg),c())})}"undefined"==typeof WeixinJSBridge?
document.addEventListener?document.addEventListener("WeixinJSBridgeReady",d,!1):document.attachEvent&&(document.attachEvent("WeixinJSBridgeReady",d),document.attachEvent("onWeixinJSBridgeReady",d)):d()}}}]);angular.module("redirect",["account.service","wechat"]).controller("redirectCtrl",["$stateParams","$state","$ionicHistory","agreementConstants","CommonAuthenticationService","Wechat",function(a,b,c,f,e,h){var l=!!h.isQQBrowser();void 0!==a.providerUserId&&"null"!==a.providerUserId&&h.setOpenId(a.providerUserId);void 0!=a.xAuthToken&&(e.setXAuthToken(a.xAuthToken),e.setMobile(a.mobile));c.nextViewOptions({historyRoot:!0});"agreements"===a.state?b.go("app.agreement.list",{toPropose:"0",paygo:"0",user:"1"}):
"agreementsToPropose"===a.state?b.go("app.agreement.list",{toPropose:"1",paygo:"0",user:"1"}):"coupons"===a.state?!0===l?b.go("app.coupon.listQQx5"):b.go("app.coupon.list"):"account"===a.state?b.go("app.account.show"):"transactions"===a.state?!0===l?b.go("app.transaction.listQQx5"):b.go("app.transaction.list"):"simulate"===a.state?b.go("app.proposal.start",{agreementId:f.AGREEMENT_ID_SIMULATE}):"dxk"===a.state?b.go("app.account.salesOrComm"):b.go("app.portal.category")}]);angular.module("regression",["wechat"]).controller("PublicPromotionCtrl",["$stateParams","$state","urlConfig","wechatConstants",function(a,b,c,f){window.location.replace(c.REST_END_POINT+f.PROMOTION_SHARE_ROOT+a.id)}]).controller("PublicSurveyCtrl",["$stateParams","$state","urlConfig","wechatConstants",function(a,b,c,f){window.location.replace(c.REST_END_POINT+f.SURVEY_SHARE_ROOT+a.id)}]);angular.module("transaction",["transaction.service","wechat","ng-iscroll","account.service"]).controller("TransactionCtrl",["$scope","$state","$ionicHistory","TransAPI","$rootScope","$ionicLoading","eventNames","agreementConstants",function(a,b,c,f,e,h,l,g){var k=function(){a.transactions=[];a.refresh(function(){h.show({template:"<ion-spinner></ion-spinner>",delay:100})},function(){h.hide()},function(){e.navToIndex()})},d=function(){a.transactions=void 0;a.pageNumber=void 0;a.hasTransaction=void 0;
...
b()})};a.canLoadNext=function(){return f.hasMoreToLoad()};a.isSimulate=function(a){return a.productName===g.PRODUCT_NAME_SIMULATE};k();e.$on("$stateChangeStart",function(a,b,c,d,e){"app.transaction"!==b.name&&"app.transaction.list"!==b.name&&"app.transaction.detail"!==b.name&&"app.transaction.listQQx5"!==b.name||"app.transaction.detail"===d.name||"app.transaction.list"===d.name||"app.transaction.listQQx5"===d.name||k()});e.$on("event:auth-loginCancelled",function(){d()});e.$on("event:auth-logout-complete",
function(){d()});e.$on(l.PROPOSAL_SUCCESS,function(a,b){f.clean()})}]).controller("TransactionListCtrl",["$scope","$timeout",function(a,b){a.loadMore=function(){console.log("load more");a.$parent.loadNext(function(){a.$broadcast("scroll.infiniteScrollComplete")})};a.refresh=function(){a.$parent.refresh(function(){},function(){b(function(){a.$broadcast("scroll.refreshComplete")},500)},function(){})};a.canLoadMore=function(){return a.$parent.canLoadNext()}}]).controller("TransactionListQQx5Ctrl",["$scope",
...
0},function(){})};a.page=0;b.$on("$stateChangeStart",function(b,f,e,h,l){"app.transaction"!==f.name&&"app.transaction.list"!==f.name&&"app.transaction.detail"!==f.name&&"app.transaction.listQQx5"!==f.name||"app.transaction.detail"===h.name||"app.transaction.list"===h.name||"app.transaction.listQQx5"===h.name||(a.page=0)})}]).controller("TransactionDetailCtrl",["$scope","$stateParams","TransAPI","AccountAPI","$ionicPopup","$ionicLoading",function(a,b,c,f,e,h){a.transaction=c.get(b.id);(function(){f.getAccount(function(b){a.account=
b},function(a){console.log(a)})})();var l=function(a,b,c){e.alert({title:a,template:b,okText:c})};a.NoEPolicy=function(a){l("\u4ea4\u6613\u672a\u5b8c\u6210","<p>\u5f53\u524d\u4ea4\u6613\u672a\u5b8c\u6210\uff0c\u65e0\u6cd5\u83b7\u53d6\u7535\u5b50\u4fdd\u5355</p>","\u786e\u8ba4")};a.sendEmail=function(b){a.data={};a.data.email=a.account.email;e.show({template:'<form name="ePolicyForm" ><input name="email" type="email" ng-model="data.email" required/> <p class="assertive" ng-show="ePolicyForm.email.$invalid">\u90ae\u7bb1\u5730\u5740\u683c\u5f0f\u9519\u8bef</p>  </form>',
title:"\u53d1\u9001\u7535\u5b50\u4fdd\u5355",subTitle:"\u7535\u5b50\u4fdd\u5355\u5c06\u53d1\u9001\u5230\u4e0b\u65b9\u7535\u5b50\u90ae\u7bb1\u4e2d",scope:a,buttons:[{text:"\u53d6\u6d88"},{text:"<b>\u53d1\u9001</b>",type:"button-positive",onTap:function(e){a.data.email?(h.show({template:"<ion-spinner></ion-spinner>",delay:100}),a.account.email=a.data.email,c.sendEmail(b,a.data.email,function(a){h.hide();l("\u7535\u5b50\u4fdd\u5355\u53d1\u9001\u6210\u529f","<p>\u7535\u5b50\u4fdd\u5355\u5df2\u7ecf\u6210\u529f\u53d1\u9001\u5230\u60a8\u7684\u7535\u5b50\u90ae\u7bb1\uff01</p>",
"\u786e\u8ba4")},function(b){h.hide();a.initFinish=!0;console.log(b);l("\u7535\u5b50\u4fdd\u5355\u53d1\u9001\u5931\u8d25","<p>"+b+"</p>","\u786e\u8ba4");after();failOver()})):e.preventDefault()}}]})}}]);
...
b(c)},function(a){e(a.data.error)})},h=function(a,b,c,e){f.send({id:a,email:b},function(a){console.log("transaction page init success");c(a)},function(a){e(a.data.error)})},l=function(a,b){g={};k=0;c.query({page:0},function(b){k=b.metaData.total;for(var c=[],d=0;d<b.list.length;d++)g[b.list[d].id]=b.list[d],c.push(b.list[d]);console.log("transaction metaData init success");a(c)},function(a){b(a.data.error)})},g={},k=0;return{getPage:function(a,b,c){e(a,b,c)},refresh:function(a,b){l(a,b)},get:function(a){return g[a]},
sendEmail:function(a,b,c,e){return h(a,b,c,e)},hasMoreToLoad:function(){return!!(void 0!==g&&0!==Object.keys(g).length&&Object.keys(g).length<k)},clean:function(){g=void 0;k=0}}}]);angular.module("common-authentication",["wechat"]).service("CommonAuthenticationService",["$resource","$rootScope","$http","urlConfig","Wechat",function(a,b,c,f,e){var h=a(f.REST_END_POINT+"/sso/userCanRegister/:id",{id:"@id"},{check:{method:"GET",isArray:!1}},null),l=function(a){c.defaults.headers.common["x-auth-token"]=a},g=function(a,b,g,h,u){var d=e.getOpenId();void 0===d&&(d="");void 0==g&&(g="");c.post(f.REST_END_POINT+"/auth","mobile="+a+"&validationCode="+b+"&invitationCode="+g+"&providerUserId="+
...
k=void 0;a()})},setXAuthToken:function(a){l(a)},getXAuthToken:function(){return c.defaults.headers.common["x-auth-token"]},setMobile:function(a){k=a},getMobile:function(){return k},clean:function(){k=c.defaults.headers.common["x-auth-token"]=void 0}}}]);angular.module("ng-iscroll",[]).service("iScrollAccessor",function(){var a;return{set:function(b){a=b},get:function(){return a}}}).directive("iScroll",["iScrollAccessor",function(a){return{restrict:"A",link:function(b,c){var f=new IScroll(c[0],{click:!0,bounce:!0,preventDefaultException:{tagName:/^(INPUT|TEXTAREA|BUTTON|SELECT)$/,isContentEditable:/^true$/}});a.set(f);c.on("$destroy",function(){f.destroy();f=null})}}}]).directive("iScrollRefresh",["iScrollAccessor","$timeout",function(a,b){return{restrict:"A",
link:function(c){c.$last&&b(function(){a.get().refresh()})}}}]);var qrcode=function(){function a(b,c){if("undefined"==typeof b.length)throw Error(b.length+"/"+c);var d=function(){for(var a=0;a<b.length&&0==b[a];)a+=1;for(var d=Array(b.length-a+c),e=0;e<b.length-a;e+=1)d[e]=b[e+a];return d}(),f={getAt:function(a){return d[a]},getLength:function(){return d.length},multiply:function(b){for(var c=Array(f.getLength()+b.getLength()-1),d=0;d<f.getLength();d+=1)for(var q=0;q<b.getLength();q+=1)c[d+q]^=e.gexp(e.glog(f.getAt(d))+e.glog(b.getAt(q)));return a(c,0)},mod:function(b){if(0>
f.getLength()-b.getLength())return f;for(var c=e.glog(f.getAt(0))-e.glog(b.getAt(0)),d=Array(f.getLength()),q=0;q<f.getLength();q+=1)d[q]=f.getAt(q);for(q=0;q<b.getLength();q+=1)d[q]^=e.gexp(e.glog(b.getAt(q))+c);return a(d,0).mod(b)}};return f}var b=function(b,d){var e=c[d],k=null,q=0,y=null,B=[],m={},u=function(c,d){for(var g=q=4*b+17,m=Array(g),r=0;r<g;r+=1){m[r]=Array(g);for(var x=0;x<g;x+=1)m[r][x]=null}k=m;n(0,0);n(q-7,0);n(0,q-7);g=f.getPatternPosition(b);for(m=0;m<g.length;m+=1)for(r=0;r<
g.length;r+=1){var x=g[m],u=g[r];if(null==k[x][u])for(var z=-2;2>=z;z+=1)for(var t=-2;2>=t;t+=1)k[x+z][u+t]=-2==z||2==z||-2==t||2==t||0==z&&0==t?!0:!1}for(g=8;g<q-8;g+=1)null==k[g][6]&&(k[g][6]=0==g%2);for(g=8;g<q-8;g+=1)null==k[6][g]&&(k[6][g]=0==g%2);g=f.getBCHTypeInfo(e<<3|d);for(m=0;15>m;m+=1)r=!c&&1==(g>>m&1),6>m?k[m][8]=r:8>m?k[m+1][8]=r:k[q-15+m][8]=r;for(m=0;15>m;m+=1)r=!c&&1==(g>>m&1),8>m?k[8][q-m-1]=r:9>m?k[8][15-m-1+1]=r:k[8][15-m-1]=r;k[q-8][8]=!c;if(7<=b){g=f.getBCHTypeNumber(b);for(m=
0;18>m;m+=1)r=!c&&1==(g>>m&1),k[Math.floor(m/3)][m%3+q-8-3]=r;for(m=0;18>m;m+=1)r=!c&&1==(g>>m&1),k[m%3+q-8-3][Math.floor(m/3)]=r}if(null==y){g=h.getRSBlocks(b,e);m=l();for(r=0;r<B.length;r+=1)x=B[r],m.put(x.getMode(),4),m.put(x.getLength(),f.getLengthInBits(x.getMode(),b)),x.write(m);for(r=x=0;r<g.length;r+=1)x+=g[r].dataCount;if(m.getLengthInBits()>8*x)throw Error("code length overflow. ("+m.getLengthInBits()+">"+8*x+")");for(m.getLengthInBits()+4<=8*x&&m.put(0,4);0!=m.getLengthInBits()%8;)m.putBit(!1);
for(;!(m.getLengthInBits()>=8*x);){m.put(236,8);if(m.getLengthInBits()>=8*x)break;m.put(17,8)}for(var A=0,x=r=0,u=Array(g.length),z=Array(g.length),t=0;t<g.length;t+=1){var p=g[t].dataCount,C=g[t].totalCount-p,r=Math.max(r,p),x=Math.max(x,C);u[t]=Array(p);for(var w=0;w<u[t].length;w+=1)u[t][w]=255&m.getBuffer()[w+A];A+=p;w=f.getErrorCorrectPolynomial(C);p=a(u[t],w.getLength()-1).mod(w);z[t]=Array(w.getLength()-1);for(w=0;w<z[t].length;w+=1)C=w+p.getLength()-z[t].length,z[t][w]=0<=C?p.getAt(C):0}for(w=
m=0;w<g.length;w+=1)m+=g[w].totalCount;m=Array(m);for(w=A=0;w<r;w+=1)for(t=0;t<g.length;t+=1)w<u[t].length&&(m[A]=u[t][w],A+=1);for(w=0;w<x;w+=1)for(t=0;t<g.length;t+=1)w<z[t].length&&(m[A]=z[t][w],A+=1);y=m}g=y;m=-1;r=q-1;x=7;u=0;z=f.getMaskFunction(d);for(t=q-1;0<t;t-=2)for(6==t&&--t;;){for(w=0;2>w;w+=1)null==k[r][t-w]&&(A=!1,u<g.length&&(A=1==(g[u]>>>x&1)),z(r,t-w)&&(A=!A),k[r][t-w]=A,--x,-1==x&&(u+=1,x=7));r+=m;if(0>r||q<=r){r-=m;m=-m;break}}},n=function(a,b){for(var c=-1;7>=c;c+=1)if(!(-1>=a+
c||q<=a+c))for(var d=-1;7>=d;d+=1)-1>=b+d||q<=b+d||(k[a+c][b+d]=0<=c&&6>=c&&(0==d||6==d)||0<=d&&6>=d&&(0==c||6==c)||2<=c&&4>=c&&2<=d&&4>=d?!0:!1)};m.addData=function(a){a=g(a);B.push(a);y=null};m.isDark=function(a,b){if(0>a||q<=a||0>b||q<=b)throw Error(a+","+b);return k[a][b]};m.getModuleCount=function(){return q};m.make=function(){for(var a=0,b=0,c=0;8>c;c+=1){u(!0,c);var d=f.getLostPoint(m);if(0==c||a>d)a=d,b=c}u(!1,b)};m.createTableTag=function(a,b){a=a||2;var c;c='<table style=" border-width: 0px; border-style: none; border-collapse: collapse;'+
...
a+"/errorCorrectLevel:"+c);for(var f=d.length/3,g=[],k=0;k<f;k+=1)for(var h=d[3*k+0],y=d[3*k+1],q=d[3*k+2],l=0;l<h;l+=1)g.push(b(y,q));return g};return d}(),l=function(){var a=[],b=0,c={getBuffer:function(){return a},getAt:function(b){return 1==(a[Math.floor(b/8)]>>>7-b%8&1)},put:function(a,b){for(var d=0;d<b;d+=1)c.putBit(1==(a>>>b-d-1&1))},getLengthInBits:function(){return b},putBit:function(c){var d=Math.floor(b/8);a.length<=d&&a.push(0);c&&(a[d]|=128>>>b%8);b+=1}};return c},g=function(a){var c=
...
f.writeShort(b);f.writeByte(128);f.writeByte(0);f.writeByte(0);f.writeByte(0);f.writeByte(0);f.writeByte(0);f.writeByte(255);f.writeByte(255);f.writeByte(255);f.writeString(",");f.writeShort(0);f.writeShort(0);f.writeShort(a);f.writeShort(b);f.writeByte(0);var g;g=3;for(var h=e(),l=0;4>l;l+=1)h.add(String.fromCharCode(l));h.add(String.fromCharCode(4));h.add(String.fromCharCode(5));var l=k(),y=d(l);y.write(4,g);for(var n=0,q=String.fromCharCode(c[n]),n=n+1;n<c.length;){var p=String.fromCharCode(c[n]),
n=n+1;h.contains(q+p)?q+=p:(y.write(h.indexOf(q),g),4095>h.size()&&(h.size()==1<<g&&(g+=1),h.add(q+p)),q=p)}y.write(h.indexOf(q),g);y.write(5,g);y.flush();g=l.toByteArray();f.writeByte(2);for(h=0;255<g.length-h;)f.writeByte(255),f.writeBytes(g,h,255),h+=255;f.writeByte(g.length-h);f.writeBytes(g,h,g.length-h);f.writeByte(0);f.writeString(";")}}},v=function(a,b,c,e){for(var f=n(a,b),g=0;g<b;g+=1)for(var h=0;h<a;h+=1)f.setPixel(h,g,c(h,g));c=k();f.write(c);f=d();c=c.toByteArray();for(g=0;g<c.length;g+=
...
angular.module("wechat.service",[]).constant("wechatConstants",{SHARE_IMG_URL:"img/promotion/share.png",TIMELINE_IMG_URL:"img/promotion/share.png",PROMOTION_SHARE_ROOT:"/wechatlogin/oauth2?state=promotion:",SURVEY_SHARE_ROOT:"/wechatlogin/oauth2?state=survey:",CLAIM_SHARE_ROOT:"/#/claim/"}).service("Wechat",["urlConfig","$resource","$location","wechatConstants",function(a,b,c,f){var e,h=b(a.REST_END_POINT+"/api/wechat/config",{url:"@url"}),l=b(a.REST_END_POINT+"/wechatlogin/oauth2/bind",{openId:"@openId"}),
g=function(a,b,d){var e=new h;a=a?c.protocol()+"://"+c.host()+"/":c.absUrl();e.$get({url:a},function(a){q=a;console.log("refresh wechat mp config success");b()},function(a){q=void 0;console.log("refresh wechat mp config error by: "+a.data.error);d(a)})},k=function(a,b,c){wx.chooseImage({count:1,sizeType:["compressed"],sourceType:["album","camera"],success:function(a){b(a.localIds)}})},d=function(a,b,c){wx.uploadImage({localId:a,isShowProgressTips:1,success:function(a){b(a.serverId)}})},p=function(a,
...
b,c,d){void 0===q?g(a,function(){v(t,b,c,d)},function(a){alert("\u5fae\u4fe1\u73af\u5883\u9519\u8bef\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u9875\u9762")}):v(t,b,c,d)},doWxPay:function(a,b,c){void 0===q?g(!0,function(){v(r,a,b,c)},function(a){alert("\u5fae\u4fe1\u73af\u5883\u9519\u8bef\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u9875\u9762")}):v(r,a,b,c)},chooseImage:function(a,b){void 0===q?g(!0,function(){v(k,"",a,b)},function(a){alert("\u5fae\u4fe1\u73af\u5883\u9519\u8bef\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u9875\u9762")}):
v(k,"",a,b)},previewImage:function(a,b,c,d){void 0===q?g(!0,function(){v(n,a,b,c,d)},function(a){alert("\u5fae\u4fe1\u73af\u5883\u9519\u8bef\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u9875\u9762")}):v(n,a,b,c,d)},getUserLocation:function(a,b){void 0===q?g(!0,function(){v(p,"",a,b)},function(a){alert("\u5fae\u4fe1\u73af\u5883\u9519\u8bef\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u9875\u9762")}):v(p,"",a,b)},uploadImage:function(a,b,c){void 0===q?g(!0,function(){v(d,a,b,c)},function(a){alert("\u5fae\u4fe1\u73af\u5883\u9519\u8bef\uff0c\u8bf7\u91cd\u65b0\u6253\u5f00\u9875\u9762")}):
v(d,a,b,c)},isQQBrowser:function(){return-1!==navigator.userAgent.indexOf("MQQBrowser")},bind:function(a,b,c){(new l).$save({openId:a},b,function(a){c(a.data.error)})},getOpenId:function(){return e},setOpenId:function(a){e=a}}}]);
